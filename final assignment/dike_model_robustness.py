...
if __name__ == "__main__":
    ...
    pd.DataFrame(scenarios.designs, columns=scenarios.params).to_csv(os.path.join('experiment', 'scenarios(100_1000).csv'), index=False)
    # write policies to csv
    robust_results.to_csv(os.path.join('experiment', 'robust_policies(100_1000).csv'), index=False)
